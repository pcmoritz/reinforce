...
def fc_net(inputs, num_classes=10):
  ...
  fc1 = slim.fully_connected(inputs, 16, scope="fc1")
  # fc2 = slim.fully_connected(fc1, 64, scope="fc2")
  fc2 = slim.fully_connected(fc1, num_classes, weights_initializer=normc_initializer(0.01), scope="fc2")
  # logstd = tf.get_variable(name="logstd", shape=[1, num_classes//2], initializer=tf.zeros_initializer)
  # return tf.concat(1, [fc2, 0*fc2 + logstd])
  return fc2
